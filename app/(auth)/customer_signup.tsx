...
// Hardcoded OTP (you can change this value)
...
const SignUpScreen = () => {
  ...
  const handleSubmit = async (): Promise<void> => {
    if (!showOTPInput) {
      ...
      // Second click: Verify OTP and create account
      if (!verificationCode.trim()) {
        Alert.alert('Required Field', 'Please enter the verification code');
        return;
      }

      if (verificationCode !== HARDCODED_OTP) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* OTP Input (Only shown after clicking Create Account) */}
        {showOTPInput && (
          <View style={styles.inputGroup}>
